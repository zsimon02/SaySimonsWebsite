...
export const founders = [
  {
    ...
    role: "Co-Founder",
    bio: "Dr. Hayley Simon is a clinical psychologist and behavioral lead behind SaySimons, bringing a research-driven understanding of how people communicate, connect, and build relationships. Her work focuses on helping individuals better understand their emotional patterns, navigate relationships, and communicate with more clarity and intention.\n\nThe idea for SaySimons was shaped by a question that continued to surface in her work. After watching her older brother struggle with dating apps that felt difficult to interpret, Hayley began to recognize a broader pattern. Many people weren’t struggling with connection itself, they were struggling with how little structure existed around expressing interest, reading intent, and understanding one another. What should feel intuitive often turned into guesswork. We lose all nonverbal social cues when we speak online (tone of voice, body language, eye contact). That led her to consider, what if there was an app that helped translate some of this ambiguity to help simulate more of a real world setting?\n\nHayley’s research throughout school focused on social dynamics, communication patterns, and the ways digital environments influence relationships. At SaySimons, she leads the behavioral design of the product, ensuring that psychological insight is translated into an experience that feels grounded, natural, and genuinely useful.",
